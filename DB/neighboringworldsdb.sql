...
INSERT INTO `user_comment` (`id`, `title`, `content`, `comment_date`, `user_id`, `an_event_id`, `in_reply_to_id`) VALUES (6, '好玩又好吃!', '我們當天不但吃得很飽，而且交了許多新朋友～', '2022-06-20', 34, 7, NULL);
INSERT INTO `user_comment` (`id`, `title`, `content`, `comment_date`, `user_id`, `an_event_id`, `in_reply_to_id`) VALUES (7, '推薦！', '去了亞洲超市後，我們去了老師家煮飯。用完餐唱了歌唱到半夜～', '2022-06-20', 31, 7, NULL);
